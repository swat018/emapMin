...
public class WebController {	
	...
	// 기상 정보
    @RequestMapping("/api/weather/wind")
	public void getWeatherWind(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		List<WeatherVO> slist = mapService.getWeatherWind(vo);
    ...
    // 온도
    @RequestMapping("/api/weather/tempair")
    public void getWeatherTempair(HttpServletRequest req, HttpServletResponse res) throws Exception {
        WeatherVO vo = new WeatherVO();
        String dateToTable = (String)req.getParameter("date"); // 20231203
        vo.setDate(dateToTable);
        ...
        // 쿼리문 1 실행
        mapService.getWeatherTempair1();

        mapService.getWeatherTempair2(vo);
        mapService.getWeatherTempair3(vo);
        mapService.getWeatherTempair4(vo);
        mapService.getWeatherTempair5(vo);

        List<WeatherVO> slist = mapService.getWeatherTempair6(vo);

        if(slist.size() > 0) { // 간단한 json 생성
            String jsonResponse = "[{\"ok\": 1}]";
    ...
    @RequestMapping("/api/weather/tempwater")
    public void getWeatherTempwater(HttpServletRequest req, HttpServletResponse res) throws Exception {
        WeatherVO vo = new WeatherVO();
        String dateToTable = (String)req.getParameter("date"); // 20231203
        vo.setDate(dateToTable);
        ...
        // 쿼리문 1 실행
        mapService.getWeatherTempwater1();

        mapService.getWeatherTempwater2(vo);
        mapService.getWeatherTempwater3(vo);
        mapService.getWeatherTempwater4(vo);
        mapService.getWeatherTempwater5(vo);

        List<WeatherVO> slist = mapService.getWeatherTempwater6(vo);
